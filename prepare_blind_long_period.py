...
# ============================================================
# OpenStar Blind A long-period validation project
# ============================================================

PROJECT_ID = "openstar.tess-blind-long-period-v1"
PROJECT_NAME = "OpenStar Blind A Long Period Test v1"
...
# Wider blind follow-up search. 0.03 cycles/day allows periods
# up to about 33 days while keeping the same upper bound.
...
def main():
    ...
    print()
    print("⭐ OpenStar Blind A Long-Period Preprocessor")
    ...
    print()
    print("✅ OpenStar Blind A long-period project ready")
    print(f"   project: {PROJECT_ID}")
