...
# ============================================================
# OpenStar Blind A Sector 28 validation project
# ============================================================

PROJECT_ID = "openstar.tess-blind-sector28-v1"
PROJECT_NAME = "OpenStar Blind A Sector 28 Validation v1"
...
def main():
    ...
    print()
    print("⭐ OpenStar Blind A Sector 28 Preprocessor")
    ...
    print()
    print("✅ OpenStar Blind A Sector 28 project ready")
    print(f"   project: {PROJECT_ID}")
