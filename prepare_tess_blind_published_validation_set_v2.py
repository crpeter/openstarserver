...
# ============================================================
# OpenStar Blind Published-Period Validation Set v2
#
# Goal:
...
PROJECT_ID = "openstar.tess-blind-published-v2"
PROJECT_NAME = "OpenStar Blind Published-Period Validation Set v2"
...
LOCK_PATH = (
    PROJECTS_DIR
    / "openstar.tess-blind-published-v2.lock.json"
)

MANIFEST_PATH = (
    PROJECTS_DIR
    / "openstar.tess-blind-published-v2.json"
)
...
MAX_PREFLIGHT_CANDIDATES = 80

TIC_MATCH_RADIUS_ARCSEC = 3.0
MAX_TIC_MATCH_SEPARATION_ARCSEC = 2.0
...
def evaluate_candidates(
    ...
    if (
        ...
        raise RuntimeError(
            ...
            "preflight; eight are required. "
            "Increase the candidate/field pool rather than "
            "loosening the science rules."
        )
...
def select_and_lock():
    ...
    print()
    print(
        "⭐ OpenStar Blind Published-Period Validation v2"
    )
    print(
        "🔒 SELECT + LOCK"
    )
